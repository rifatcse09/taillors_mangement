...
var purchase_events = {
    ...
    init : function(){
        ...
        $('#pur_item_add_form').on('submit',function(e){
            ...
            //alert(item_name);
            purchase.pur_item_add(item, item_name, pur_price.val(), pur_quantity.val(), pur_subtotal_price.val(),sale_price.val());
...
*/
    ...
    /*purchase item add*/
    pur_item_add : function(item, item_name,pur_price, pur_quantity, pur_subtotal_price, sale_price){
        if(item == ""){
        ...
        $('<tr>'+
            ...
            '<td class="text-right">'+pur_quantity+'</td>'+
            '<td class="text-right">'+pur_price+'</td>'+
            '<td class="text-right">'+pur_subtotal_price+'</td>'+
            '<td class="text-right">'+sale_price+'</td>'+
        ...
        for(var i = 1; i< total_row - 1; i++)
        {
            var ttrprc = $('#pur_item_table tr:eq('+i+') td:eq(5)').text().trim();
    ...
    pur_table_edit : function(ind){
        ...
        var item_price = $('#pur_item_table tr:eq('+ind+') td:eq(4)').html().trim();
        var quantity = $('#pur_item_table tr:eq('+ind+') td:eq(3)').html().trim();
        var total_price = $('#pur_item_table tr:eq('+ind+') td:eq(5)').html().trim();
        var sale_price = $('#pur_item_table tr:eq('+ind+') td:eq(6)').html().trim();

        $('[name="pur_tr_index"]').val(ind);
        $('[name="pur_price"]').val(item_price);
        $('[name="pur_quantity"]').val(quantity);
        $('[name="pur_subtotal_price"]').val(total_price);
        $('[name="sale_price"]').val(sale_price);
        $("#pur_item_show").val(item_id).change();
    ...
    purchase_item_insert : function(){
        ...
        for(var i = 1; i<total_row-1; i++)
        {
            ...
            val_arr.push($('#pur_item_table tr:eq('+i+') td:eq(3)').text().trim());
