                   ...
                   <?php
                    ...
                    while($invd_row = $invd_q->fetch_assoc())
                    {
                       ...
                       // $rounding = $invd_row['rounding'];
                        ...
                        $paid_total = $invd_row['g_total'];
                        $due_amount = $invd_row['due'];
                        $qnty = $invd_row['qnty'];
                        $tra_date = $invd_row['tra_date'];
                        $cashier = $invd_row['name'];
                        $custid = $invd_row['cus_id'];
						$discount = $invd_row['discount_total'];
               ...
               <tr class="">
                    ...
                    <tr class="">
                      <td colspan="3" align="right">Net Payable:</td>
                       <td></td>
                       <td></td>
                      <td align="right"><?php $total=$g_total+$total_vat; echo number_format($total, 2, '.', ','); ?></td>
                    </tr>
                </tbody>
                </table>

                <!--price end-->
                <div style="width:100%;margin-top:20px;!border:1px solid #333;font-size:11px;margin-left:10px;">
