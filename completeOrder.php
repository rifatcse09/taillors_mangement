    ...
    <div class="contentpanel">
        ...
        <div class="pull-left breadcrumb_admin clear_both">
            <div class="pull-left page_title theme_color">
                ...
                <h2 class="">কমপ্লিট অর্ডার</h2>
            </div>
            <div class="pull-right">
                <ol class="breadcrumb">
                    <li><a href="#">ড্যাশবোর্ড</a></li>
                    <li>Order</li>
                    <li class="active">কমপ্লিট অর্ডার</li>
                </ol>
            </div>
        </div>
                        ...
                        <div class="col-md-12">
                            <div class="block-web">
                                <div class="header">
                                    ...
                                    <h3 class="content-header">কমপ্লিট অর্ডার লিস্ট</h3>
                                </div>
                                <div class="porlets-content">
                                    <div class="table-responsive">
                                        <table class="display table table-bordered table-striped" id="dynamic-table">
                                            ...
                                            <?php
                                            $sl = 1;
                                            $query = $cls_booking->completeOrder();
                                            while($order_row = $query->fetch_assoc())
                                            {
                                                ...
                                                <tr class="gradeC">
                                                    ...
                                                    <td style='width:20%'>
                                                        ...
                                                        <a class="btn btn-primary" data-toggle="tooltip" title="Delivered!" style='float:left' onclick="deliveredFunction('<?php echo $order_row['order_no']; ?>')" ><i class="fa fa-check-square-o" aria-hidden="true"></i></a>
                                                    </td>
